...
import { CustomHeaderBack, AppButton, AppText, FormWrapper, InputWithLabel, ListItemImage } from '@components/common';
...
class PatientBookCaregiversDateTimesUrgent extends Component {
  ...
  onPressNext = () => {
    ...
    const { services, caregiverTimes, inputName, inputMobileNumber, inputEmailAddress } = this.state;
  ...
  render() {
    ...
    return (
      <SafeAreaView style={Globals.safeAreaView}>
        <CustomHeaderBack title="Urgent Care" onPressBack={this.onPressBack} />
        <DateTimePickerModal
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.introContainerB}>
            <AppText textWeight="300" style={styles.textIntro}>
              Our Care Planner will contact you at the number below. Please confirm this information is correct or make
          ...
          <KeyboardAwareScrollView
            ...
            <FormWrapper style={styles.formWrapper}>
              ...
              <InputWithLabel
                ...
                onChangeText={text => this.setState({ inputMobileNumber: text })}
              />
              <InputWithLabel
                ...
                onChangeText={text => this.setState({ inputEmailAddress: text })}
              />
            </FormWrapper>
          </KeyboardAwareScrollView>
        </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientBookCaregiversDateTimesUrgent);
