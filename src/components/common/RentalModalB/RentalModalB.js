...
import styles from './RentalModalB.styles';

export default class RentalModalB extends Component {
  constructor(props) {
    super(props);
...
//      items: props.selectedItem.rentOptions,
      ...
      <Modal
        ...
        <View style={styles.wrap}>
          <View style={styles.wrapInner}>
            ...
            {selectedItem.rentOptions.map((item, index) => (
