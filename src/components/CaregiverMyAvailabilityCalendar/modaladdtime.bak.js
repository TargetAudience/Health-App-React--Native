...
import { ButtonLoading, InputWithLabel, FormWrapper, CheckmarkToggle } from '@components/common';
...
class ModalAddTime extends Component {
  ...
  onPressSave = () => {
    const { actions, defaultTimes, onPressSaved } = this.props;
    const {
      startTimeDisplay,
      endTimeDisplay,
      availableCheckmark,
    ...
    CaregiverAvailabilityApi.addSpecificTime({start: startTimeDisplay, end: endTimeDisplay, available: availableCheckmark, note, date: selectedDate })
      .promise.then(result => {
        const id = result.data.id;

        actions.addSpecificTime({id, start: startTimeDisplay, end: endTimeDisplay, available: availableCheckmark, note, date: selectedDate });
  ...
  onPressAvailableType = selection => {
    this.setState({ availableCheckmark: selection })
  }
  ...
  render() {
    ...
    const { currentDay, buttonEnabled, actionLoading, note, isTimePickerVisible, availableCheckmark, startTimeChanged, endTimeChanged, startTimeDisplay, endTimeDisplay } = this.state;
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.container}>
              ...
              <View style={styles.checkMarkContainer}>
                <Checkmark text="Available" checked={availableCheckmark === 'available'} onPress={() => this.onPressAvailableType('available')} />
                <Checkmark text="Not Available" checked={availableCheckmark === 'notavailable'} onPress={() => this.onPressAvailableType('notavailable')} />
              </View>
